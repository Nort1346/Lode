...
/dev/disk1s5   482797652 348296532 134501120  73% /`
    ...
    const result = checkDiskSpace('/media', 7)
...
/dev/disk1s5   104857600  52428800  52428800  50% /`
    ...
    const results = checkAllDisks(['/media', '/data'], 7)
...
/dev/disk1s5   104857600  52428800  52428800  50% /`
    ...
    const result = findTargetDisk(['/media', '/data'], '/media/Movies', 7)
...
/dev/disk1s5   104857600  52428800  52428800  50% /`
    ...
    const result = findTargetDisk(['/media', '/data'], '/other/path', 7)
